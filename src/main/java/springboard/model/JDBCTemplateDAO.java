...
public class JDBCTemplateDAO {
	...
	public ArrayList<SpringBoardDTO> list(Map<String , Object> map){
		...
		그러므로 DAO에서 개발자가 반복적으로 작성햇던 코드를 생략할수
		있다.
		 */
	...
	public void updateHit(String idx) {
		...
		/*
		update() 메서드는 int형의 반환값이 있지만 필요없는 경우에는
	...
	public int password(String idx, String pass) {
		...
		/*
		일련번호는 시쿼스를 사용하므로 반드시 1이상의 값을 가지게된다.
	...
	public boolean deleteConfirm(String idx) {
		...
		//int여서 Integer.class를 쓴걸로 추정중...
		int replyCount = template.queryForObject(sql,
				Integer.class, 
